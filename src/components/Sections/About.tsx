...
const About = () => {
  ...
  return (
    <motion.div className="flex md:flex-row flex-col items-center justify-between py-20 gap-20">
      ...
      <motion.div className="flex flex-col items-start gap-10 max-w-2xl">
        <motion.h2 className="text-5xl font-bold text-[#1E3240]">Award winning real estate company in Dubai</motion.h2>
