  ...
  return (
    ...
    {open &&
      <div className="relative w-full bg-white h-full">
        ...
        <motion.ul className="flex items-center justify-center  gap-10 flex-col text-xl h-full bg-blue-100 rounded-lg text-[#1E3240] py-10 hover:text-black shadow-inner" animate={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 0.5 }}> 
      ...
      <div className="flex justify-between items-center py-5 relative">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <motion.div className="hamburger md:hidden block cursor-pointer" onClick={handleClick} animate={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} transition={{ duration: 0.5 }}>
        <motion.span
